...
typedef struct {
  ...
  size_t logicalSize;//logical current size of vector
  size_t allocatedSize;//for how many elems do ve have space
  size_t reallocSize;// by how many elems should be added each time
  size_t elemSize;//single element size
  void *elems;//pointer to elems
